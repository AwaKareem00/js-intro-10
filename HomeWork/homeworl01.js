...
console.log(` \t \JavaScript is a high-level programming language primarily used to build \n web applications. It is not limited to the  web; it can also be used \n for the backend development with technologies like Node.js. \n\n
  \t \It is open source and has a huge community support, which means \n there are plenty of resources and support available for learning. It uses\ \n a syntax like other programming languages and easy to learn.`);
...
console.log(`The product of the number is = ${number1 * number2}`);
...
console.log(`The perimiter of the square = ${side * 4}`);

console.log(`The area of the square = ${side * side}`);

console.log('\n-------------------TASK11---------------------\n');

let favBook = 'JS Alorithms & Data Structures';
let favColor = 'Blue';
let favNumber = 7;
...
console.log(`\tUser who joined this program is ${firstName} ${lastName}. John's age is ${age}.\ \nJohn's email address is ${emailAddress}, phone number is \n${phoneNumber}, and adress is ${address}.`);