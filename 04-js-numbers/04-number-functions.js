...
// toFixed() vs toPercision()
console.log(123.23.toFixed(1)); // 123.2
console.log(123.23.toPrecision(3)); // 123

console.log(10.957.toFixed(2)); // 10.96
console.log(10.951.toPrecision(2)); //11


// Convwerting other values like data types to numbers.
...
console.log((parseFloat(num1) + parseFloat(num2)). toFixed(0)); // 10.3 before fixed which is 10


console.log(Number.parseFloat(num1) + Number.parseFloat(num2)); // 10.3 DONT DO THIS
...
console.log(Number.isInteger(23416239581209)); // true
console.log(Number.isSafeInteger(23416239581209832649832469)); // false
